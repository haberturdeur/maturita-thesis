...
\makethanks{Rád bych poděkoval vedoucímu mojí práce, Ing. Václavu Zavadilovi za podnětné připomínky, rady a svobodu, které mi při přípravě projektu poskytl. Dále děkuji Ing. Barnabášovi Jakabovi za pomoc s integrací výsledků mé práce do výuky konstrukčního cvičení na této škole. V neposlední řadě velmi děkuji všem vyučujícím předmětu KOC za jejich zájem o využití videonávodů vzniklých v rámci tohoto projektu do jejich výuky. Na závěr bych rád poděkoval studentům, kteří přišli s náměty na některá videa.}
...
SolidWorks, 3D modelování, CAD, videonávody, P3D, Parallax media production, Parallax3D
...
\subsection*{Keywords}
SolidWorks, 3D modelling, CAD, videoguides, P3D, Parallax media production, Parallax3D
...
% Uplatnění práce
\input{CHAPTERS/020 - UPLATNENI.tex}
